<template>
  <div class="pl-6 pt-6 pb-6">
    ...
    <div>
      <a href="/auth/signin" target="_blank">/auth/signin</a>
    </div>
  </div>

  <div class="pl-6 pb-6">
    <h6 class="h3 fw-600">User Pages</h6>
    <div>
    <a href="/user/dashboard" target="_blank">/user/dashboard</a> <br>
    <a href="/user/cases" target="_blank">/user/cases</a> <br>
    <a href="/user/case-pathology" target="_blank">/user/case-pathology</a> <br>
    <a href="/user/case-pathology-history" target="_blank">/user/case-pathology-history</a> <br>

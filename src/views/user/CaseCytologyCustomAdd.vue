<template>
  ...
  <section class="section-full">
    <div class="container">
      <form action="/user/case-cytology-complete" method="POST" @submit="onSubmit">
        ...
        <div class="section-px section-py-grid" data-aos="fade-up" data-aos-delay="150">
          <div class="grids">
            ...
            <div class="grid xl-20 md-1-3 xs-75">
              <FormGroup 
                type="datepicker" label="*วันที่เก็บตัวอย่าง" name="sample_date" placeholder="22/11/2528" 
                :value="dataset.sampleDate" @input="dataset.sampleDate = $event" 
                :errorText="isValidated && !dataset.sampleDate? 'กรุณาระบุ': ''" 
                :classer="isValidated && !dataset.sampleDate? 'error': ''" 
              />
            </div>
            <div class="sep"></div>

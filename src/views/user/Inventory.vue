...
.total-cart{ display:inline-block; text-align:center; position:absolute; right:-1.75rem; font-size: 1rem; line-height: 1.625rem; width:1.5rem; height: 1.5rem; border-radius: 50%; background-color: #BC4A4A; color: #fff; }

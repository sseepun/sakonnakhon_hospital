    ...
    <div class="container">
      ...
      <div class="section-px section-py-grid pos-relative" style="z-index:1;" data-aos="fade-up" data-aos-delay="150">
        <div class="grids">
          ...
          <!-- Second row -->
          <div class="grid lg-15 md-50">
            <FormGroup type="plain" label="สิทธิการรักษา" value="ประกันสังคมข้าราชการ" />
          </div>
          <div class="grid lg-45 md-50">
            <FormGroup type="plain" label="ที่อยู่" value="83 พาร์ทเม้นท์ ราชพฤกษ์เพลส ซ.มหาสวัสดิ์ 4 ถ.ราชพฤกษ์ ต.มหาสวัสดิ์อ.บางกรวย จ.นนทบุรี 11130" />
          </div>
          <div class="grid lg-15 md-50">

        ...
        <div class="section-header" data-aos="fade-up" data-aos-delay="0">
          ...
          <div class="header-wrapper">
            <div class="text-container">
              <h6 class="h3">สร้างผู้ใช้งานใหม่</h6>
            </div>
        ...
        <div class="section-px section-py-grid" data-aos="fade-up" data-aos-delay="150">
          <div class="grids">
            <div class="grid lg-20 md-1-3 xs-75">
              <FormGroup type="text" label="รหัสประจำตัวผู้ใช้งาน" name="user_id" placeholder="00000" />
            </div>
            <div class="grid lg-20 md-1-3 xs-75">
              <FormGroup type="text" label="*ชื่อผู้ใช้งาน" name="username" placeholder="Username" :required="true" />
            </div>
            <div class="grid lg-20 md-1-3 xs-75">
              <FormGroup type="password" label="*รหัสผ่าน" name="password" :required="true" />
            </div>
            <div class="grid lg-20 md-1-3 xs-75">
              <FormGroup type="password" label="*ยืนยันรหัสผ่าน" name="conf_password" :required="true" />
            </div>
            <div class="sep"></div>
            ...
            <div class="grid lg-20 md-1-3 xs-75">
              <FormGroup type="text" label="*ชื่อ" name="firstname" :required="true" />
            </div>
            <div class="grid lg-20 md-1-3 xs-75">
              <FormGroup type="text" label="*นามสกุล" name="lastname" :required="true" />
            </div>
            <div class="grid lg-20 md-1-3 xs-75">
              <FormGroup
            ...
            <div class="grid lg-20 md-1-3 xs-75">
              <FormGroup 
                type="text" label="รหัสแพทย์" name="doctor_id" placeholder="00000" 
                :disabled="position != 2"
              />
            </div>
            <div class="grid lg-20 md-1-3 xs-75">
            ...
            <div class="grid lg-20 md-1-3 xs-75">
              <FormGroup type="email" label="*อีเมล" name="email" placeholder="sakonnakhon@mail.com" :required="true" />
            </div>
            <div class="grid lg-20 md-1-3 xs-75">
              <FormGroup type="text" label="หมายเลขโทรศัพท์" name="phone" placeholder="012-3456789" :required="true" />
            </div>
          </div>
        </div>
        ...
        <div class="section-px section-py-grid" data-aos="fade-up" data-aos-delay="300">
          <div class="grids">
            <div class="grid sm-100">
              <CheckboxSet 
                label="*สิทธิ์การใช้งาน" name="role" :value="roleId" :required="true" 
                :options="[
                  { value: 1, text: 'Admin' },
